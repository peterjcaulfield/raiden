...
class Request {
    ...
    constructor(requestKey, config, userArgs) {
        ...
        var sanitized = Object.assign(defaults, helpers.cloneWithDefinedProps(config), helpers.cloneWithDefinedProps(userArgs));

        this.url =  this._getUrl(sanitized.protocol, sanitized.env, sanitized.endpoint, sanitized.query)
