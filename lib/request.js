...
class Request {
    ...
    constructor(requestKey, config, userArgs) {
        ...
        this.rawConfig = Object.assign({ env: '127.0.0.1' },
                                      config,
    ...
    _applyTransforms() {
        ...
        if (this.rawConfig.transforms instanceof Array) {
            ...
            this.rawConfig.transforms.forEach((t) => {
                ...
                if (this.rawConfig.body.hasOwnProperty(t.key)) {
                    this.rawConfig.body[t.key] = transformers[t.transform[0]].apply(null, [t.transform[1]])
                } else {
