...
class Request {
    ...
    constructor(requestKey, config, userArgs) {
        ...
        this.sanitizedConfig = Object.assign(defaults,
    ...
    _getUrl() {
        return `${this.sanitizedConfig.protocol}//${this.sanitizedConfig.env}/${this.sanitizedConfig.endpoint ? this.sanitizedConfig.endpoint : ''}${this.sanitizedConfig.query ? '?' + this.sanitizedConfig.query : ''}`
    }
