...
describe('lib/cmd/config', () => {
    ...
    it('config loads empty object with empty config file', () => {

        const yaml = require('js-yaml'),
              fs = require('fs');

        fs.readFileSync.mockReturnValue('');
        yaml.safeLoad.mockReturnValue(null);
        ...
        expect(Object.keys.mock.calls.length).toEqual(1);
        expect(Object.keys.mock.calls[0][0]).toEqual({});
